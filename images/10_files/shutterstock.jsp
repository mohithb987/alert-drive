		...
		usi_app.load = function () {
			...
			try {
				...
				if (!usi_app.suppress_page) {
					if(usi_app.is_enabled && (usi_app.get_user_status("user").status == "guest" || usi_app.get_user_status("user").isActive == "false")) {
						...
						// OLD LAUNCH LOGIC - REMOVE EVERYTHING IN THIS CONDITIONAL WHEN NEW LOGIC APPROVED
						if (usi_app.is_flex_account_page) {
